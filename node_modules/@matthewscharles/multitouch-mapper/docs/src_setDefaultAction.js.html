...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/setDefaultAction.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/setDefaultAction.js</h1>
 ...
 * 
 * @param {object} action function to perform
 * @returns {object} this for method chaining
 */

const setDefaultAction = function(action){
    this.setAction('default','all',action)
    return this;
}

module.exports = setDefaultAction;</code></pre>
        </article>
    </section>
