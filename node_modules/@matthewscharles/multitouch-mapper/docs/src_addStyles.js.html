...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/addStyles.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/addStyles.js</h1>
 ...
 * Add a style element to the document with the desired classes
 */


const addStyles = function(){
    this.stylesheet = document.createElement('style');
    this.stylesheet.innerHTML = `.${this.classes.detect}{
        pointer-events:auto;
        touch-action:none;
    }
        \n.
...
module.exports = addStyles;</code></pre>
        </article>
    </section>
