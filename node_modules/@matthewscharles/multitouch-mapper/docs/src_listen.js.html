...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: src/listen.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: src/listen.js</h1>
...
const listen = function(target = document){
  ...
  console.log(`multitouch mapper listening on ${target == document ? 'document' : target.id}...`)
  return this;
}

module.exports = listen;</code></pre>
        </article>
    </section>
