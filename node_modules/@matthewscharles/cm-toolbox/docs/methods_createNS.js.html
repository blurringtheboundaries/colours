...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: methods/createNS.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: methods/createNS.js</h1>
 ...
 * @param {string} type 
 * @param {object} obj 
 * @param {object} document usually the document, but we may need to specify this e.g. if using JSDOM 
 * @returns {HTMLElement} 
 */

var createNS = function(type, obj, container=document){
    let element = container.createElementNS(xmlns, type)
    set(element, obj)
    return element
}
