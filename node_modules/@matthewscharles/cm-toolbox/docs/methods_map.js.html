...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: methods/map.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: methods/map.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// const constrain = require('./constrain')
