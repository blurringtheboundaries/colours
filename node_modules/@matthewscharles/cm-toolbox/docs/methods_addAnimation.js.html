...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: methods/addAnimation.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: methods/addAnimation.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// const createAnimation = require('./createAnimation')
...
export { addAnimation }
// module.exports = addAnimation;</code></pre>
        </article>
    </section>
