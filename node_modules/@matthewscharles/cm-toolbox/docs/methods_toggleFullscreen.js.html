...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: methods/toggleFullscreen.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: methods/toggleFullscreen.js</h1>
 ...
 * @example
 * toggleFullscreen();
 * @returns {boolean} true if fullscreen mode is enabled in the browser, false if not
 */
