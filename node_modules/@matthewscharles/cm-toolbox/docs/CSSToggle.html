...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Class: CSSToggle</title>
...
<div id="main">
    ...
    <h1 class="page-title">Class: CSSToggle</h1>
...
<header>
        ...
        <h2><span class="attribs"><span class="type-signature"></span></span>CSSToggle<span class="signature">(element, on, attack, release, effectClass, parameter)</span><span class="type-signature"></span></h2>
        
            <div class="class-description"><p>CSSToggle
Control a CSS property with a toggle
to replace over-complex SVG animations</p></div>
...
<article>
    ...
    <h4 class="name" id="CSSToggle"><span class="type-signature"></span>new CSSToggle<span class="signature">(element, on, attack, release, effectClass, parameter)</span><span class="type-signature"></span></h4>
...
<span class="param-type">number</span>
        ...
        <tr>
                ...
                <td class="name"><code>effectClass</code></td>
...
<dl class="details">
    ...
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="classes_CSSToggle.js.html">classes/CSSToggle.js</a>, <a href="classes_CSSToggle.js.html#line17">line 17</a>
    </li></ul></dd>
    ...
    <pre class="prettyprint"><code>let toggle = new CSSToggle(document.querySelector('rect'), false, 0.1, 0.3, 'hc--light', 'fill');</code></pre>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="classes_CSSToggle.js.html">classes/CSSToggle.js</a>, <a href="classes_CSSToggle.js.html#line41">line 41</a>
    </li></ul></dd>
    ...
    <h4 class="name" id="trigger"><span class="type-signature"></span>trigger<span class="signature">(on, trigger)</span><span class="type-signature"></span></h4>
...
<dl class="details">
    ...
    <dt class="tag-source">Source:</dt>
    <dd class="tag-source"><ul class="dummy"><li>
        <a href="classes_CSSToggle.js.html">classes/CSSToggle.js</a>, <a href="classes_CSSToggle.js.html#line56">line 56</a>
    </li></ul></dd>
