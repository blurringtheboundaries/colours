...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: methods/createAnimation.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: methods/createAnimation.js</h1>
    ...
    <section>
        <article>
            <pre class="prettyprint source linenums"><code>// const createNS = require('./createNS')
...
export { createAnimation }</code></pre>
        </article>
    </section>
